...
/*    Przygotuj niewielką strukturę danych w.NET Core.Stwórz klasę abstrakcyjną Osoba z polami Id, Imię i Nazwisko.Następnie 
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            tpt.Pracownik.Add(new Pracownik { DataZatrudnienia = DateTime.Now, Imie = "Tomek", Nazwisko = " Kowalski" });
           ...
           /* var tpc = new TPCKontext();
            ...
            tpc.People.Add(new Klient { NrRejestracyjny = "dfg34g34", NrTelefonu = "231-435-125", Imie = "Stanisław", Nazwisko = " Nowak" });
            tpc.SaveChanges();*/
        }
    }
}
